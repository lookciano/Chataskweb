...
describe("weekly summary data", () => {
  it("keeps all task descriptions grouped by responsible", () => {
    ...
    const data = calculateWeeklySummaryData([
      { id: 1, taskNumber: 10, description: "Concluir medição", assignedToName: "Ana", status: "completed", createdAt: new Date(2026, 7, 17) },
      { id: 2, taskNumber: 11, description: "Emitir relatório", assignedToName: "Ana", status: "pending", createdAt: new Date(2026, 7, 15) },
    ], "Sala A", start, end);
